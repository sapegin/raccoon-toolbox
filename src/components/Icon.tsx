...
const ICONS: Record<string, IconInfo> = {
  ...
  bluesky: {
    path: 'M11 17.013H9v.985H8v.973H6v-.934H4V17H2v-3h2v-2H2v-1H1V8.541H0V3.5h1V2h1v1h2v1.026h2v1.946h2V7h1v3.002h2V7h1V5.972h2V4.026h2V3h2V2h1v1.5h1v5.041h-1V11h-1v1h-2v2h2v3h-2v1.037h-2v.934h-2v-.973h-1v-.985Z',
  },
  mastodon: {
